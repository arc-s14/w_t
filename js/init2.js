...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			global:		{ range: '*', href: '../css/style.css', containers: '94%', grid: { gutters: 50 } },
			wider:		{ range: '1680-', href: '../css/style-wide.css', containers: '94%', grid: { gutters: 50 } },
			wide:		{ range: '-1680', href: '../css/style-wide.css', containers: 1200, grid: { gutters: 40 } },
			normal:		{ range: '-1280', href: '../css/style-normal.css', containers: 1100, lockViewport: true },
